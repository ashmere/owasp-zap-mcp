...
class ZAPMCPSseServer:
    ...
    async def mcp_message(self, request: Request):
        ...
        try:
            ...
            if method == "initialize":
                ...
                logger.info(f"MCP Initialize - Protocol: {protocol_version}, Client: {client_info}")
    ...
    async def call_tool(self, tool_name: str, arguments: Dict[str, Any], request: Request) -> Any:
        """Call a tool by name with arguments"""
        try:
            logger.info(f"Calling tool: {tool_name}, Arguments: {json.dumps(arguments, ensure_ascii=False)}")
            ...
            try:
                ...
                if hasattr(tool_instance, 'run'):
                    ...
                    if hasattr(tool_instance, 'func'):
                        ...
                        raise ValueError(f"Tool '{tool_name}' is not callable and has no recognized execution method")
