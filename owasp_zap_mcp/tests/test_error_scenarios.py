...
class TestConnectionErrorScenarios:
    ...
    @pytest.mark.asyncio
    async def test_health_check_connection_refused(self, mock_zap_client_connection_error):
    ...
    async def test_spider_scan_connection_error(self, mock_zap_client_connection_error):
        ...
        mock_zap_client_connection_error.spider_scan.side_effect = ConnectionError("Connection refused")
    ...
    async def test_active_scan_connection_error(self, mock_zap_client_connection_error):
        ...
        mock_zap_client_connection_error.active_scan.side_effect = ConnectionError("Connection refused")
    ...
    async def test_get_alerts_connection_error(self, mock_zap_client_connection_error):
        ...
        mock_zap_client_connection_error.get_alerts.side_effect = ConnectionError("Connection refused")
...
class TestZAPAPIErrors:
    ...
    async def test_spider_scan_api_error(self, mock_zap_client_api_errors):
        ...
        mock_zap_client_api_errors.spider_scan.side_effect = RuntimeError("ZAP API error: Invalid URL format")
    ...
    async def test_active_scan_api_error(self, mock_zap_client_api_errors):
        ...
        mock_zap_client_api_errors.active_scan.side_effect = RuntimeError("ZAP API error: Scan not allowed")
    ...
    async def test_get_spider_status_invalid_scan_id(self, mock_zap_client_api_errors):
        ...
        mock_zap_client_api_errors.get_spider_status.side_effect = RuntimeError("Invalid scan ID: 999")
    ...
    @pytest.mark.asyncio
    async def test_get_active_scan_status_invalid_scan_id(self, mock_zap_client_api_errors):
        """Test active scan status with invalid scan ID."""
        mock_zap_client_api_errors.get_active_scan_status.side_effect = RuntimeError("Invalid scan ID: 999")
    ...
    async def test_generate_html_report_api_error(self, mock_zap_client_api_errors):
        ...
        mock_zap_client_api_errors.generate_html_report.side_effect = RuntimeError("Report generation failed")
    ...
    async def test_generate_json_report_api_error(self, mock_zap_client_api_errors):
        ...
        mock_zap_client_api_errors.generate_json_report.side_effect = RuntimeError("Report generation failed")
    ...
    async def test_clear_session_api_error(self, mock_zap_client_api_errors):
        ...
        mock_zap_client_api_errors.clear_session.side_effect = RuntimeError("Session clear failed")
...
class TestTimeoutScenarios:
    ...
    async def test_spider_scan_timeout(self, mock_zap_client_timeout):
        ...
        mock_zap_client_timeout.spider_scan.side_effect = asyncio.TimeoutError("Spider scan timeout")
    ...
    async def test_active_scan_timeout(self, mock_zap_client_timeout):
        ...
        mock_zap_client_timeout.active_scan.side_effect = asyncio.TimeoutError("Active scan timeout")
    ...
    async def test_get_alerts_timeout(self, mock_zap_client_timeout):
        ...
        mock_zap_client_timeout.get_alerts.side_effect = asyncio.TimeoutError("Get alerts timeout")
    ...
    async def test_health_check_timeout(self, mock_zap_client_timeout):
        ...
        mock_zap_client_timeout.health_check.side_effect = asyncio.TimeoutError("Health check timeout")
...
class TestURLNormalizationEdgeCases:
    ...
    def test_normalize_url_edge_cases(self):
        ...
        edge_cases = [
            ...
            ("localhost.localdomain", "https://localhost.localdomain"),  # Has dot, should be normalized
...
class TestDataCorruptionScenarios:
    ...
    async def test_malformed_json_report_data(self, mock_zap_client_malformed_data):
        ...
        mock_zap_client_malformed_data.generate_json_report.return_value = {}  # Missing total_alerts
